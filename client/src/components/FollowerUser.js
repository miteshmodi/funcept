    ...
    const handleFollow = e => {
        ...
        followService.check(props.user._id).then(result => {
            ...
            if (result.data.length > 0) {
                swalRemoveLike(`You are already following this user. Do you want to unfollow?`, () => {
        ...
        <div className="container text-center story-box">
            <div className="row">
                ...
                <div className="col-4 col-xs-4 col-sm-4 col-md-4 text-right">
                    <button className="btn btn-sm btn-primary m-1" onClick={handleFollow}>Follow</button>
                </div>
            </div>
            <div className="row">
